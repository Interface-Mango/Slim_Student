...
namespace Slim_Student.Model
{
    class DB_AllProgram
    {
        ...
        public enum FIELD
        {
            id, process_name, sub_id, lecturer_id, lecture_time, red_green, is_all_red, END
        }
        ...
        public List<object[]> SelectAllProgramList(int sub_id)
        {
            string sql = "SELECT * FROM all_program WHERE sub_id=@arg1";
